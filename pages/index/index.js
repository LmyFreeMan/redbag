...
var loginInfo = {};
Page({
  setConfig:{url:'https://www.scwcw.cn'},
  data: {
    userInfo: {},   // 用户信息
  ...
  formSubmit: function (e) {
    ...
    if (mode == 0){
      datas.quest = valkl;
      //口令提交信息
      var postUrl =  'https://www.scwcw.cn/index.php/Api/Enve/saveEnve';
              ...
              if (res.authSetting['scope.userInfo']) {
                ...
                wx.getUserInfo({
                  success: res => {
                    ...
                    console.log(infoUser.gender)
                    // for (var a in infoUser) 
                    // {
                    //   console.log(a)
                    // }
